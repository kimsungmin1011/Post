...
import com.example.guestbook.service.GuestBookService2;
...
@RequestMapping("/guestbook2")  // 이 컨트롤러에서 처리하는 모든 요청의 기본 URL 경로를 "/guestbook2"으로 설정합니다.
@CrossOrigin(origins = "*") // React 앱의 URL을 여기에 지정
public class GuestBookController2 {
    ...
    public void addEntry(@RequestBody Entry entry2) {
        // 전달받은 방명록 항목을 추가합니다.
        guestBookService.addEntry(entry2);
    }
}
